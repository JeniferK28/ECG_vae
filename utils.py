...
# if i == 0 or i == 1213 or i == 1553 or i == 15930 or i == 12900 or i == 21073:
#     fs = 360
#     y = fft.fft(traindata[i])
#     freq = np.fft.fftfreq(y.size, 1 / 360)
#     plt.plot(freq, np.abs(y))
#     plt.show()
#     # pxx, freq, bins, im = plt.specgram(x=traindata[i], Fs=fs, noverlap=18, NFFT=36)
#     # plt.axis('off')
#     # name = 'C:/Users/DSK/ECG/spec_test/' + str(i) + '.png'
#     # plt.savefig(name, bbox_inches='tight', transparent=True, dpi=300, frameon='false', pad_inches=0.0)
